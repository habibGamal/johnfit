                            ...
                            <div class="row align-items-center">
                                <div class="col-xl-2 col-lg-3 col-6">
                                    <div class="header_logo">
                                        <a href="index-1.html" class="custom_cursor_orangeglow">
                                            <img src="{{asset('/images/home/logos/gymort_logo.png')}}" alt="header_logo"
                                                class="img-fluid">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-7 col-12 d-lg-block d-none">
                                    <div class="desktop_navbar">
                                        <nav>
                                            <ul class="dasktop_navlist satoshi_fontfamily">
                                                <li class="nav-items">
                                                    <a href="/#hero"
                                                        class="nav-links active custom_cursor_orangeglow">Home
                                                    </a>
                                                </li>
                                                <li class="nav-items">
                                                    <a href="/#about"
                                                        class="nav-links custom_cursor_orangeglow">About
                                                    </a>
                                                </li>
                                                <li class="nav-items">
                                                    <a href="/#hero"
                                                        class="nav-links custom_cursor_orangeglow">Calculator
                                                    </a>
                                                </li>
                                                <li class="nav-items">
                                                    <a href="/#hero"
                                                        class="nav-links custom_cursor_orangeglow">Pricing
                                                    </a>
                                                </li>
                                                <li class="nav-items">
                                                    <a href="/#hero"
                                                        class="nav-links custom_cursor_orangeglow">Contact
                                                    </a>
                                                </li>
                                                <li class="nav-items">
                                                    <a href="/#hero"
                                    ...
                                    <div class="header_toggle_menu_area">
                                        <div class="header_tooglemenu">
                                            <div class="orangeglow">
                                                <button class="btn sidebar_btn" type="button"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-xl-5 col-lg-6">
                                                                <div class="nav_get_in_touch">
                                                                    ...
                                                                    <div class="header_get_touch_contact">
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-lg-12 col-md-4 col-sm-4">
                                                                                <div
                                                                                    class="header_single_get_touch_box">
                                                                                    <div
                                                                                        class="header_get_touch_icon">
                                                                                        <svg width="48"
                                                                                            height="48"
                                                                                            viewBox="0 0 48 48"
                                                                                            fill="none"
                                                                                    ...
                                                                                    <div
                                                                                        class="header_get_touch_detail color_white">
                                                                                        <span
                                                                                            class="color_lightgray">CALL
                                                                                            US</span>
                                                                                        <a href="tel:+12345678899"
                                                                                            class="line_height_normal satoshi_fontfamily color_white triners_icons">+1
                                                                                            234 567 8899</a>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="header_get_touch_detail">
                                                                                        <span
                                                                                            class="color_lightgray">Email
                                                                                            Now</span>
                                                                                        <a href="mailto:hello@gymort.com"
                                                                                            class="line_height_normal satoshi_fontfamily color_white triners_icons">hello@gymort.com</a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <svg width="48"
                                                                                            ...
                                                                                            <g>
                                                                                                ...
                                                                                                <path
                                                                                                    d="M35.314 33.3144L26.828 41.8004C26.078 42.5497 25.0612 42.9705 24.001 42.9705C22.9408 42.9705 21.924 42.5497 21.174 41.8004L12.686 33.3144C10.4484 31.0767 8.92468 28.2258 8.30738 25.1221C7.69009 22.0184 8.00699 18.8014 9.21801 15.8779C10.429 12.9543 12.4798 10.4555 15.111 8.69741C17.7421 6.93934 20.8355 6.00098 24 6.00098C27.1645 6.00098 30.2579 6.93934 32.889 8.69741C35.5202 10.4555 37.571 12.9543 38.782 15.8779C39.993 18.8014 40.3099 22.0184 39.6926 25.1221C39.0753 28.2258 37.5516 31.0767 35.314 33.3144Z"
                                                                                                    stroke="#fff"
                                                                                                    stroke-width="2"
                                                                                                    stroke-linecap="round"
                                                                                                    stroke-linejoin="round">
                                                                                    ...
                                                                                    <div
                                                                                        class="header_get_touch_detail">
                                                                                        <span
                                                                                            class="color_lightgray">WE
                                                                                            ARE HERE</span>
                                                                                        <a href="https://www.google.com/maps"
                                                                                            class="line_height_normal satoshi_fontfamily color_white triners_icons">27
                                                                                            West 24th St New
                                                                                            Your, NY 10010</a>
                                                                                    </div>
                                                                                </div>
                                                                    ...
                                                                    <div class="header_get_touch_sociallink">
                                                                        <div class="row">
                                                                            <div
                                                                                class="col-lg-6 col-md-3 col-sm-6">
                                                            ...
                                                            <div class="col-xl-7 col-lg-6">
                                                                <div class="mobile_navbar">
                                                                    <ul
                                                                        class="mobile_navlist satoshi_fontfamily">
                                                                        <li
                                                                            class="nav-item-mobile position-relative">
                                                                            ...
                                                                            <ul
                                                                                class="drop_down_menu drop_down_mobile_1">
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="index-1.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">Home
                                                                                        1</a></li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="index-2.html"
                                                                        ...
                                                                        <li
                                                                            class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);"
                                                                                class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Pages
                                                                                <span>
                                                                                    <svg width="24" height="24"
                                                                                        viewBox="0 0 24 24"
                                                                                        fill="none"
                                                                            ...
                                                                            <ul
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <a href="about-us.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">About
                                                                                        Us</a></li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Our
                                                                                        Team
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                    ...
                                                                                    <ul
                                                                                        class="inner_dropdown_menu">
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="our-team-v1.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Team
                                                                                                V1</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="our-team-v2.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Team
                                                                                                V2</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    ...
                                                                                    <a href="BMI-calculator.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">BMI
                                                                                        Calculator</a></li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Timetable
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                                viewBox="0 0 24 24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="class-timetable.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Class
                                                                                                Timetable</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-class-timetable.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Single
                                                                                                Class
                                                                                                Timetable</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                ...
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="our-program.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">Our
                                                                                        Program</a></li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="pricing-plans-v1.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Pricing
                                                                                                V1</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="pricing-plans-v2.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Pricing
                                                                                                V2</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="faqs.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">FAQs</a>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="coming-soon.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">Coming
                                                                                        Soon</a></li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="error-404.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">Error
                                                                                        404</a></li>
                                                                            </ul>
                                                                        </li>
                                                                        <li
                                                                            class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);"
                                                                                class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Projects
                                                                                <span>
                                                                                    <svg width="24" height="24"
                                                                                        viewBox="0 0 24 24"
                                                                                        fill="none"
                                                                            ...
                                                                            <ul
                                                                                ...
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Grids
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                                viewBox="0 0 24 24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-2-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid
                                                                                                2 Columns</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-3-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid
                                                                                                3 Columns</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-4-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid
                                                                                                4 Columns</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                ...
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Grid
                                                                                        Wide
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-wide-3-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">3
                                                                                                Columns Wide</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-wide-4-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">4
                                                                                                Columns Wide</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-grid-wide-5-column.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">5
                                                                                                Columns Wide</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Masonry
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                                viewBox="0 0 24 24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-masonry-v1.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry
                                                                                                V1</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-masonry-v2.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry
                                                                                                V2</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-masonry-v3.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry
                                                                                                V3</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-masonry-v4.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Masonry
                                                                                                V4</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Gallery
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                                viewBox="0 0 24 24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="grid-gallery.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Grid
                                                                                                Gallery</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="joined-gallery.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Joined
                                                                                                Gallery</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="javascript:void(0);"
                                                                                        class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Single
                                                                                        Images
                                                                                        <span>
                                                                                            <svg width="24"
                                                                                                height="24"
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-single-images.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Images</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-small-images.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Small
                                                                                                Images</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-big-images.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Big
                                                                                                Images</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-single-slider.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Slider</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-small-slider.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Small
                                                                                                Slider</a></li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="project-big-slider.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Big
                                                                                                Slider</a></li>
                                                                                    </ul>
                                                                                </li>
                                                                                <li
                                                                                    class="nav-item-mobile position-relative">
                                                                                    <a href="project-single-video.html"
                                                                                        class="nav-link-mobile position-relative custom_cursor_orangeglow">Single
                                                                                        Video</a></li>
                                                                            </ul>
                                                                        </li>
                                                                        <li
                                                                            class="nav-item-mobile position-relative">
                                                                            <a href="javascript:void(0);"
                                                                                class="nav-link-mobile position-relative drop-down custom_cursor_orangeglow">Blogs
                                                                                <span>
                                                                                    <svg width="24" height="24"
                                                                                        viewBox="0 0 24 24"
                                                                                        fill="none"
                                                                            ...
                                                                            <ul
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard-right-sidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard Right
                                                                                                Sidebar</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-standard-left-sidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard Left
                                                                                                Sidebar</a>
                                                                                        </li>
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-listing-v1.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Listing V1</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="blogs-listing-v2.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Listing V2</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Gallery</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Youtube
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Quote</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Link</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-rightsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Gallery</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Youtube
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Quote</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Link</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-leftsidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                                ...
                                                                                <li
                                                                                    ...
                                                                                    <ul
                                                                                        ...
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-standard-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Standard</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-gallery-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Gallery</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-video-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-youtube-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Youtube
                                                                                                Video</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-quote-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Quote</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-link-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Link</a>
                                                                                        </li>
                                                                                        <li
                                                                                            class="nav-item-mobile position-relative">
                                                                                            <a href="single-blog-music-nosidebar.html"
                                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Blogs
                                                                                                Music</a>
                                                                                        </li>
                                                                                    </ul>
                                                                        ...
                                                                        <li
                                                                            class="nav-item-mobile position-relative">
                                                                            <a href="contact-us.html"
                                                                                class="nav-link-mobile position-relative custom_cursor_orangeglow">Contact
                                                                                US</a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
