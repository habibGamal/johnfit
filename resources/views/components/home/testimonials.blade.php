<section class="client_say_slider_sec" id="testimonials">
                        ...
                        <div class="client_say_slider_v2_list lazy">
                            <div class="client_say_slider_v2_item">
                                <div class="client_say_slider_v2_box">
                                    <div class="client_say_slider_v2_img d-lg-block d-none"
                                        ...
                                        <img src="{{asset('/images/home/dummy-img/review1.jpeg')}}"
                                            alt="client_say">
                                    </div>
                                    ...
                                    <div class="client_say_slider_v2_detail d-lg-block d-none"
                                        ...
                                        <div class="client_say_img_detail">
                                            <h5 class="line_height_normal">Moataz Hussein Ahmed</h5>
                            ...
                            <div class="client_say_slider_v2_item">
                                <div class="client_say_slider_v2_box">
                                    <div class="client_say_slider_v2_img d-lg-block d-none"
                                        data-animation-in="fadeInUp" data-delay-in="0.2">
                                        <img src="{{asset('/images/home/dummy-img/review2.jpeg')}}"
                                            alt="client_say">
                                    </div>
                                    <div class="client_say_slider_v2_img d-lg-none d-block"
                                        data-animation-in="fadeInDown" data-delay-in="0.2">
                                    ...
                                    <div class="client_say_slider_v2_detail d-lg-block d-none"
                                        ...
                                        <div class="client_say_img_detail">
                                            <h5 class="line_height_normal">Joseph Efraim</h5>
                                            <p class="satoshi_fontfamily line_height_normmal fw_500 pt-10">
                                                Customers</p>
                                        </div>
                                    </div>
