    ...
    <div className="flex items-start gap-4 p-4 rounded-xl border border-border bg-card hover:shadow-md transition-all duration-300 group">
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between">
          <h4 className="font-bold text-foreground group-hover:text-primary transition-colors">{activity.workout}</h4>
  ...
  return (
    <Card className="shadow-sm border-border bg-card/50 backdrop-blur-sm h-full">
      <CardHeader>
        ...
        <CardDescription className="text-muted-foreground">Your latest completed workouts</CardDescription>
      </CardHeader>
      <CardContent>
        {activities && activities.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="mt-2 text-base font-semibold text-foreground">No activity yet</h3>
