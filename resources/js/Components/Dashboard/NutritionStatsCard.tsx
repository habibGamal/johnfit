...
export default function NutritionStatsCard({
    ...
    return (
        <Card className="h-full flex flex-col shadow-sm border-border bg-card/50 backdrop-blur-sm">
            <CardHeader>
                ...
                <CardDescription className="text-muted-foreground">Daily average consumption</CardDescription>
            </CardHeader>
            <CardContent className="flex-1 flex flex-col justify-between">
                <div className="mb-6">
                    <div className="flex justify-between items-baseline mb-3">
                        ...
                        <span className="text-2xl font-bold text-foreground">
                            {nutritionAverages.calories.toLocaleString()} <span className="text-sm font-normal text-muted-foreground">kcal</span>
                        </span>
                    </div>
                ...
                <div className="space-y-3 py-4 border-t border-border">
                    <div className="flex justify-between items-center p-2 rounded-lg hover:bg-muted/50 transition-colors cursor-pointer">
